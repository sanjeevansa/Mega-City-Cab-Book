...
<section class="home" id="home">
    ...
    <h3 data-speed="0" class="home-parallax">welcome to <lowercase>Mega City Cab </lowercase></h3>
	
	<h4 data-speed="0" class="home-parallax"> in sri lanka </h4>
    ...
    <a data-speed=".3" href="#" class="btn home-parallax">book vehicles</a>
